...
object NrJson {
    ...
    const val COMMAND_DEAUTH_DETECT_START = "DEAUTH_DETECT_START"
    const val COMMAND_DEAUTH_DETECT_STOP = "DEAUTH_DETECT_STOP"
    const val COMMAND_DEAUTH_DETECT_STATUS = "DEAUTH_DETECT_STATUS"
